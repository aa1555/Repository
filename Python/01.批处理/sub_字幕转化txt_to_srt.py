...
def format_subtitle(input_text):
    ...
    current_entry = {}
    time_pattern = re.compile(r'(\d{2}:\d{2}:\d{2}:\d{2}) - (\d{2}:\d{2}:\d{2}:\d{2})')
...
if __name__ == "__main__":
    input_path = r"C:\Users\aa155\Desktop\00.txt"   # 输入文件路径
    output_path = r"C:\Users\aa155\Desktop\00.srt" # 输出文件路径
