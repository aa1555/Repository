...
| 3    | 迭代进阶策略     | 按照"初始方案一漏洞排查→升级版本"的对话顺序，<br>逐步优化和改进方案。例如，在产品设计过程中，先让<br>模型生成一个初始设计方案，然后对方案进行漏洞排查，<br>如"请检查这个产品设计方案中可能存在的成本过高和<br>用户体验不佳的问题"，最后基于排查结果要求模型生<br>成升级版本                |
