...
def add_prefix_to_files():
    ...
    messagebox.showinfo("完成", "所有文件已添加前缀。")
...
tk.Label(root, text="添加前缀:").grid(row=1, column=0)
...
# 创建添加前缀按钮
add_prefix_button = tk.Button(root, text="添加前缀", command=add_prefix_to_files)
add_prefix_button.grid(row=2, column=1)
