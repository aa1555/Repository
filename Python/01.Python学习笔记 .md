...
- `.`类似于文件路径中的`/`，用来访问**子包（subpackage）**、**模块（module）**、**函数（function）**、**类（Class）**、**方法（method）**、**属性（property）** 等。
...
<p align="center">
<img src="../Misc/img/操作对象.jpg" alt="图片加载失败" width="300">
</p>
<p align="center">
<b>操作对象</b>
</p>

`.`类似于文件路径中的`/`，用来访问子模块、函数、类、方法、属性等。
