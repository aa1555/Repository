...
注意步长为负时，顺序会反转。起始值和结束值为负时，表示从右往左数，不影响顺序。只有为负的步长会让顺序反转。
...
一个对象是否可以使用某个方法或属性，取决于该类型被定义时，是否实现了相应的方法或属性，而不是取决于对象的类型。这种设计理念鼓励程序员关注对象的行为而不是对象的类型。
...
<p align="center">
<img src="https://github.com/aa1555/Repository/blob/main/Misc/img/%E6%93%8D%E4%BD%9C%E5%AF%B9%E8%B1%A1.jpg">
</p>
...
<img src="https://github.com/aa1555/Repository/blob/main/Misc/img/%E6%93%8D%E4%BD%9C%E5%AF%B9%E8%B1%A1.jpg" align="center" alt="图片加载中">
