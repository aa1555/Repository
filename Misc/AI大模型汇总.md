...
◆ 中文：https://prompts.fresns.cn/ 

   开源地址：https://github.com/jevantang/chatgpt-prompts

◆ 两个收集 GPTs 提示词的文档，通过预设这些提示词，使 ChatGPT 拥有不同的功能和角色，里面也包含了中文提示词。
